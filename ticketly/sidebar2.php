            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                    <li class="<?php if(isset($active1)){echo $active1;}?>">
                        <a href="dashboard2.php"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>

                    <li class="<?php if(isset($active2)){echo $active2;}?>">
                        <a href="tickets2.php"><i class="fa fa-ticket"></i> Tickets</a>
                    </li>
                    <li class="<?php if(isset($active8)){echo $active8;}?>">
                        <a href="about2.php"><i class="fa fa-child"></i> Sobre Mi</a>
                    </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="">
                        ...
                        <ul class="dropdown-menu dropdown-usermenu pull-right">
                            <li><a href="dashboard2.php"><i class="fa fa-user"></i> Mi cuenta</a></li>
